...
{
    public interface IBuildableProjectsSearchService
    {
        Task<IReadOnlyCollection<BuildableProjectViewModel>> SearchProjectsAsync(SolutionModeConfigurationDto configuration);
    }
}